...
<section class="quick-view">
    ...
    <?php  
        if(isset($_GET['pbarcode'])){
            $pbarcode = $_GET['pbarcode'];
            $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE barcode = '$pbarcode'") or die('query failed');
    ...
    <form action="" method="POST">
         ...
         <div class="details"><?php echo nl2br($fetch_products['specifications']); ?></div>
